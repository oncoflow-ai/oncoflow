...
- **Global scope**: `/Users/alonzyl/Desktop/coding/oncoflow/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/alonzyl/Desktop/coding/oncoflow/.codex/notes/`)
...
2. Glob `/Users/alonzyl/Desktop/coding/oncoflow/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/alonzyl/Desktop/coding/oncoflow/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/alonzyl/Desktop/coding/oncoflow/.codex/notes/` — works in any directory
